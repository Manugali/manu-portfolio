...
import { Home, Briefcase, BookText, Mail } from "lucide-react";
...
const links = [
  ...
  { href: "/blog", label: "Journal", icon: BookText },
        ...
        {links.map(({ href, label, icon: Icon }) => {
          ...
          return (
            <Link
              ...
              href={href}
              className={cn(
                "flex min-w-[64px] flex-col items-center gap-1 rounded-lg px-3 py-2 text-[10px] transition-colors",
